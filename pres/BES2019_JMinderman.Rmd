...
<div class="row">
  ...
  <div class="column"; style="width: 5%; float: left">
  </div>
  <div class="column"; style="width: 60%; float: left; align-items:center; justify-content:center;">
  ...
  <div class="column"; style="width: 30%; float: right; text-align: left">
    ...
    <a href="mailto:jeroen.minderman2@stir.ac.uk">jeroen.minderman2@stir.ac.uk</a><br>
    Dr Brad Duthie<br>
    Prof Nils Bunnefeld<br>
  </div>
  <div class="column"; style="width: 5%; float: right">
  </div>
