...
load("sims/gmse_vary_06/batch2_summary_allfiles.Rdata")
...
para_combs[para_combs$par_set==7,1:10]
...
dat1 = para_combs[para_combs$par_set == 7, ]
...
# ### Budget type == 8 (budget equal mb/ub, yield-to-budget == 1000)
dat2 = para_combs[para_combs$par_set == 8, ]
